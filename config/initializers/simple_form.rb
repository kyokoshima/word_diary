...
SimpleForm.setup do |config|
  ...
  config.wrappers :materialize, class: 'input-field',
...
#   b.use :error, wrap_with: { tag: :label, class: :error }
    ...
    b.wrapper :button_wrapper, tag: 'div', class: 'btn' do |button_wrapper|
      ...
      button_wrapper.use :input, class: :validate, error_class: :invalid 
    end
    b.wrapper :path_validate, tag: 'div', class: 'file-path-wrapper' do |path_validate_wrapper|
      path_validate_wrapper.use :input, class: 'file-path validate', type: 'text', name: 'zz', error_class: :invalid
  ...
  config.wrapper_mappings = { file: :materialize_file_input }

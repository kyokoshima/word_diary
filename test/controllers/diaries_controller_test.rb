...
class DiariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create diary" do
    assert_difference('Diary.count') do
      post diaries_url, params: { diary: { temperature: @diary.temperature, weather: @diary.weather, word: @diary.word } }
    end
  ...
  test "should update diary" do
    patch diary_url(@diary), params: { diary: { temperature: @diary.temperature, weather: @diary.weather, word: @diary.word } }
